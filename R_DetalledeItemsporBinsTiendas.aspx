        ...
        <div class="row">
            <div class="col-md-8">
                <asp:Panel ID="pnlPromoHeader" runat="server" CssClass="Panel">
                    <label class="PanelHeading">Item Detail by Bins</label>
                    <div class="row">
                        <div class="col-md-4">
                            &nbsp;&nbsp;
        ...
        <div class="row">
            <div class="col-md-8">
                <tel:RadGrid ID="rgHead" AllowSorting="True" CssClass="Panel" PageSize="20" AllowPaging="True" runat="server" ShowStatusBar="true" AutoGenerateColumns="False"
                    ...
                    <ExportSettings OpenInNewWindow="true" IgnorePaging="true" Excel-Format="Xlsx" FileName="BinItemDetailStores" UseItemStyles="true" />
