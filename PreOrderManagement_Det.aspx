            ...
            <div class="col-md-12">
                <asp:Panel ID="pnlPromoHeader" runat="server" CssClass="Panel">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            &nbsp;&nbsp;
                            <label class="myLabelXtraSmall">Status</label>
                ...
                <tel:RadGrid ID="rgHead" runat="server" 
                    ...
                    <MasterTableView Width="100%" AllowNaturalSort="false" DataKeyNames="InvoiceNumber,MagentoOrderNumber" CommandItemDisplay="Top">
                        ...
                        <Columns>
                            ...
                            <tel:GridBoundColumn SortExpression="MagentoOrderNumber" HeaderText="Magento Order No." HeaderButtonType="TextButton" DataField="MagentoOrderNumber" UniqueName="MagentoOrderNumber" HeaderStyle-Width="122px" />
                        ...
                        <div class="row" style="margin-left: 5px;">
                            <div class="col-xs-12">
                                <tel:RadGrid ID="rgDetail" runat="server" Width="90%" ShowStatusBar="true" AutoGenerateColumns="False" ExportSettings-Pdf-AllowPrinting="true"
                                    ...
                                    <SortingSettings EnableSkinSortStyles="false" />
                                    <ExportSettings OpenInNewWindow="true" IgnorePaging="true" Excel-Format="Xlsx" HideStructureColumns="true" FileName="WebOrderDetail" Pdf-AllowPrinting="true" />
