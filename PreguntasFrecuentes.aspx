...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <asp:Panel ID="pnlAddApps" runat="server" CssClass="Panel" Height="65px">
                    <label class="PanelHeading">Search FAQs</label>
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="row" style="text-align: center;">
            <div class="col-md-12">
                <h3 class="myLabelFull">Frequently Asked Questions</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <tel:RadGrid ID="rgHead" runat="server" Width="100%" ShowStatusBar="true" AutoGenerateColumns="False"
                    ...
                    <ExportSettings OpenInNewWindow="true" IgnorePaging="true" Excel-Format="Xlsx" HideStructureColumns="true" FileName="FrequentlyAskedQuestions" />
